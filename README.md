# [Scientific Reports] - [Real-Time Analysis of Soccer Ball-Player Interactions using Graph Convolutional Networks for Enhanced Game Insights](https://github.com/MrFahad/GameFlow/)
