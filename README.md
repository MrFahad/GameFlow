# <a><img src="asserts/nature.png" width="150" align="left"></a> [Real-Time Analysis of Soccer Ball-Player Interactions using Graph Convolutional Networks for Enhanced Game Insights](https://github.com/MrFahad/GameFlow/)
